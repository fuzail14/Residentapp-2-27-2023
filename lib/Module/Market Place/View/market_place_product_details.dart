        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              12.h.ph,
              buildProductName(text: "${controller.snapShot.productname}"),
              4.h.ph,
              ...
              ProductCardWidget(column: [
                ...
                ProductCardTextWidget(
                  heading: 'Post At',
                  text:
                      " ${convertTimestampDayMonth(controller.snapShot.createdAt.toString())}",
                  middleSizedBox: 60,
                ),
                ProductCardTextWidget(
                  heading: 'Status',
              ...
              ProductCardWidget(column: [
                ...
                buildOwnerProfileCard(
                    ...
                    residentType: controller.snapShot.residents!.residenttype,
                    userCreatedAt: controller.snapShot.users!.createdAt,
                    userImage: controller.snapShot.users!.image),
                16.h.ph,
                buildOwnerAddress(text: controller.snapShot.residents!.city),
                Spacer(),
                Center(
                  child: MyButton(
                    width: 288.w,
                    ...
                    onPressed: () async {
                      controller.uri =
                          Uri.parse("tel://${controller.snapShot.contact}");
                          ...
                          children: [
                            Text('Join At | ',
                                style: GoogleFonts.quicksand(
                                    ...
                                    fontWeight: FontWeight.w600,
                                    fontSize: 12.sp)),
                            Text(convertTimestampDayMonth(userCreatedAt),
                                style: GoogleFonts.quicksand(
                                    color: HexColor('#6A7380'),
                                    fontWeight: FontWeight.w600,
                                    fontSize: 12.sp)),
